  ...
  return (
    <>
      ...
      <div className="container-fluid mt-5">
        <div className="container">
          <h1 className="display-1 mb-5">
            <i className="fa fa-cogs me-2"></i> Technology
          </h1>
          <div className="row g-5 align-items-center">
          ...
          <div className="row g-5 align-items-center">
            <div className="col-lg-12 wow fadeIn" data-wow-delay="0.5s">
              ...
              <p className="mb-4">
                ...
                vitae nemo inventore magni veritatis eaque sapiente? Rem minus
                libero quos earum ipsa quae possimus. Hic aliquam deserunt velit
                ipsum facilis.
              </p>
            </div>
            <div className="col-lg-12 wow fadeIn" data-wow-delay="0.5s">
